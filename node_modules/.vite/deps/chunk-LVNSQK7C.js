...
function ve(e) {
  ...
  return ye({ namespace: n, reference: t });
}
function gn(e, n) {
  const { namespace: t, reference: r } = me(n);
  return Ee({ namespace: t, reference: r, address: e });
}
function Nn(e) {
  return B(e, he);
}
...
function Un(e, n) {
  const t = ue.sharedKey(fromString2(e, f), fromString2(n, f)), r = new import_hkdf.HKDF(import_sha256.SHA256, t).expand(J);
...
function wn(e) {
  const n = (0, import_sha256.hash)(fromString2(e, k));
  return toString2(n, f);
}
function Se(e) {
...
function jn(e) {
  ...
  if (j(n) === U && typeof e.senderPublicKey > "u")
    throw new Error("Missing sender public key for type 1 envelope");
  const t = typeof e.senderPublicKey < "u" ? fromString2(e.senderPublicKey, f) : void 0, r = typeof e.iv < "u" ? fromString2(e.iv, f) : (0, import_random.randomBytes)(W), o = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, f)).seal(r, fromString2(e.message, k));
  return Ie({ type: n, sealed: o, iv: r, senderPublicKey: t });
}
function Cn(e) {
  const n = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, f)), { sealed: t, iv: r } = Q(e.encoded), o = n.open(r, t);
  if (o === null)
...
function Q(e) {
  const n = fromString2(e, K), t = n.slice(Tn, Oe), r = Oe;
  if (j(t) === U) {
    const d = r + J, l = d + W, i = n.slice(r, d), u = n.slice(d, l), a = n.slice(l);
    return { type: t, sealed: a, iv: u, senderPublicKey: i };
  }
...
function $n(e, n) {
  const t = Q(e);
  return Pe({ type: j(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString2(t.senderPublicKey, f) : void 0, receiverPublicKey: n == null ? void 0 : n.receiverPublicKey });
}
function Pe(e) {
...
var Re = (e, n, t) => n in e ? Vn(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var Ae = (e, n) => {
  for (var t in n || (n = {}))
    Mn.call(n, t) && Re(e, t, n[t]);
  if (Te)
    for (var t of Te(n))
...
function Fn(e, n) {
  var t;
  const r = ee(), o = { protocol: e, version: n, env: r };
  return r === "browser" && (o.host = ((t = (0, import_window_getters.getLocation)()) == null ? void 0 : t.host) || "unknown"), o;
}
function De() {
  const e = detect();
  if (e === null)
...
function Ve() {
  var e;
  const n = ee();
  return n === _.browser ? [n, ((e = (0, import_window_getters.getLocation)()) == null ? void 0 : e.host) || "unknown"].join(":") : n;
}
function Me(e, n, t) {
  const r = De(), o = Ve();
...
function Hn({ protocol: e, version: n, relayUrl: t, sdkVersion: r, auth: o, projectId: s, useOnCloseEvent: c }) {
  const d = t.split("?"), l = Me(e, n, r), i = { auth: o, ua: l, projectId: s, useOnCloseEvent: c || void 0 }, u = $e(d[1] || "", i);
  return d[0] + "?" + u;
}
function qn(e) {
  let n = (e.match(/^[^:]+(?=:\/\/)/gi) || [])[0];
...
function Zn(e = import_time.FIVE_MINUTES, n) {
...
var He = (e, n, t) => n in e ? at(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var lt = (e, n) => {
  for (var t in n || (n = {}))
    ut.call(n, t) && He(e, t, n[t]);
  if (Fe)
    for (var t of Fe(n))
...
function ft(e) {
  const n = e.indexOf(":"), t = e.indexOf("?") !== -1 ? e.indexOf("?") : void 0, r = e.substring(0, n), o = e.substring(n + 1, t).split("@"), s = typeof t < "u" ? e.substring(t) : "", c = $.parse(s);
  return { protocol: r, topic: o[0], version: parseInt(o[1], 10), symKey: c.symKey, relay: qe(c) };
}
function ze(e, n = "-") {
  const t = "relay", r = {};
  return Object.keys(e).forEach((o) => {
...
var Ge = (e, n, t) => n in e ? mt(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var gt = (e, n) => {
  for (var t in n || (n = {}))
    ht.call(n, t) && Ge(e, t, n[t]);
  if (Be)
    for (var t of Be(n))
      vt.call(n, t) && Ge(e, t, n[t]);
  return e;
};
var Nt = (e, n) => yt(e, Et(n));
function T(e) {
  const n = [];
  return e.forEach((t) => {
    const [r, o] = t.split(":");
...
function bt(e, n) {
  ...
  for (const [o, s] of Object.entries(e))
    r[o] = { methods: s.methods, events: s.events, chains: s.accounts.map((c) => `${c.split(":")[0]}:${c.split(":")[1]}`) };
  return r;
}
function Ot(e) {
  ...
  Object.keys(r).forEach((i) => {
    ...
    c[i] = { chains: u, methods: a, events: g, accounts: A };
  });
  ...
  return Object.keys(o).forEach((i) => {
    ...
    l[i] = { chains: u, methods: a, events: g, accounts: A };
    ...
    }), ln = y == null ? void 0 : y.map((I) => r[i].accounts.filter((P) => P.includes(I))).flat();
    l[i] = { chains: O((g = l[i]) == null ? void 0 : g.chains, y), methods: O((A = l[i]) == null ? void 0 : A.methods, un), events: O((v = l[i]) == null ? void 0 : v.events, dn), accounts: O((p = l[i]) == null ? void 0 : p.accounts, ln) };
  }), l;
}
function te(e) {
  return e.includes(":");
...
function re(e) {
  ...
  for (const [s, c] of Object.entries(e)) {
    const d = te(s) ? [s] : c.chains, l = c.methods || [], i = c.events || [], u = Qe(s);
    o[u] = Nt(gt({}, o[u]), { chains: O(d, (n = o[u]) == null ? void 0 : n.chains), methods: O(l, (t = o[u]) == null ? void 0 : t.methods), events: O(i, (r = o[u]) == null ? void 0 : r.events) });
  }
  return o;
}
...
function m(e, n) {
  return n && S(e) ? true : typeof e == "string" && Boolean(e.trim().length);
}
function F(e, n) {
...
function Pt(e, n) {
  ...
  return b(o, r) ? (r.forEach((c) => {
    ...
    (!b(V(c, a), u) || !b(a.methods, l) || !b(a.events, i)) && (s = false);
  }), s) : false;
}
function H(e) {
...
function Ut(e, n) {
  let t = null;
  return m(e == null ? void 0 : e.publicKey, false) || (t = N("MISSING_OR_INVALID", `${n} controller public key should be a string`)), t;
}
function oe(e) {
  let n = true;
...
function tn(e, n) {
  ...
  return Object.values(e).forEach((r) => {
    if (t)
      return;
    const o = nn(r == null ? void 0 : r.accounts, `${n} namespace`);
    o && (t = o);
  }), t;
}
function rn(e, n) {
  let t = null;
  return oe(e == null ? void 0 : e.methods) ? oe(e == null ? void 0 : e.events) || (t = R("UNSUPPORTED_EVENTS", `${n}, events should be an array of strings or empty array for no events`)) : t = R("UNSUPPORTED_METHODS", `${n}, methods should be an array of strings or empty array for no methods`), t;
}
function se(e, n) {
  let t = null;
  return Object.values(e).forEach((r) => {
...
function kt(e, n, t) {
  return m(t, false) ? We(e, n).includes(t) : false;
}
function Lt(e, n, t) {
...
function Ht(e, n) {
  return F(e, false) && e <= n.max && e >= n.min;
}
...
tslib/tslib.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-LVNSQK7C.js.map
