...
var c2 = { WALLETCONNECT_DEEPLINK_CHOICE: "WALLETCONNECT_DEEPLINK_CHOICE", W3M_VERSION: "W3M_VERSION", W3M_PREFER_INJECTED_URL_FLAG: "w3mPreferInjected", RECOMMENDED_WALLET_AMOUNT: 9, isMobile() {
  ...
  typeof localStorage < "u" && localStorage.setItem(c2.W3M_VERSION, "2.4.1");
}, getWalletRouterData() {
  var e2;
...
var ne = { state: g, async getRecomendedWallets() {
  ...
  if (c2.isArray(e2)) {
    ...
    a.sort((r, p) => {
      const v = e2.indexOf(r.id), h2 = e2.indexOf(p.id);
      return v - h2;
    }), g.recomendedWallets = a;
  } else {
    const { standaloneChains: n, walletConnectVersion: s2, isAuth: a } = d.state, r = n == null ? void 0 : n.join(","), p = c2.isArray(t2), v = { page: 1, sdks: a ? "auth_v1" : void 0, entries: c2.RECOMMENDED_WALLET_AMOUNT, chains: r, version: s2, excludedIds: p ? t2.join(",") : void 0 }, { listings: h2 } = P ? await I.getMobileListings(v) : await I.getDesktopListings(v);
    g.recomendedWallets = Object.values(h2);
  }
  return g.recomendedWallets;
}, async getWallets(e2) {
  ...
  const { page: r, search: p } = e2, { listings: v, total: h2 } = P ? await I.getMobileListings(t2) : await I.getDesktopListings(t2), j = Object.values(v), L = p ? "search" : "wallets";
  return g[L] = { listings: [...g[L].listings, ...j], total: h2, page: r ?? 1 }, { listings: j, total: h2 };
...
var se = { state: E, subscribe(e2) {
  ...
  return new Promise((t2) => {
    const { isStandalone: n, isUiLoaded: s2, isDataLoaded: a, isPreferInjected: r, selectedChain: p } = d.state, { pairingUri: v } = _.state, { isConnected: h2 } = K.state, { enableNetworkView: j } = y2.state;
    if (n)
...
buffer/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MUFFYLVW.js.map
